...
FINAL_REPORT_FILE = os.path.join(OUTPUT_DIR, "informe_final.json")
...
AGENT_CONFIG = {
    ...
    "reviewer": {
        ...
        "goal": "Evaluar el producto desde tu perspectiva personal y generar una reseña detallada en formato JSON",
        "backstory": "Personalizado según el perfil del usuario"
    },
    "compiler": {
        "role": "Compilador de Reseñas",
        "goal": "Recopilar y analizar todas las reseñas de usuario en formato JSON",
